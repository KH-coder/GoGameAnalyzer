...
public class SgfAnalyzer
{
    ...
    private void GenerateRegionImage(BoardRegion region)
    {
        ...
        using (var bitmap = new Bitmap(regionWidth, regionHeight))
        using (var graphics = Graphics.FromImage(bitmap))
        {
            ...
            using (var pen = new Pen(Color.Black, 2))
            {
                ...
                graphics.DrawRectangle(pen, 
                    MARGIN, MARGIN, 
                    (region.EndX - region.StartX) * CELL_SIZE, 
                    (region.EndY - region.StartY) * CELL_SIZE);
            }
            ...
            using (var pen = new Pen(Color.Black, 1))
            {
                ...
                for (int i = 1; i < (region.EndX - region.StartX); i++)
                {
                    ...
                    graphics.DrawLine(pen,
                        linePos, MARGIN,
                        linePos, MARGIN + (region.EndY - region.StartY) * CELL_SIZE);
                }
                ...
                for (int i = 1; i < (region.EndY - region.StartY); i++)
                {
                    ...
                    graphics.DrawLine(pen,
                        MARGIN, linePos,
                        MARGIN + (region.EndX - region.StartX) * CELL_SIZE, linePos);
                }
            }
